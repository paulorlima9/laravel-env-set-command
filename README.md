...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/paulorlima9/laravel-env-set-command.svg)](https://packagist.org/packages/paulorlima9/laravel-env-set-command)
[![Total Downloads](https://img.shields.io/packagist/dt/paulorlima9/laravel-env-set-command.svg)](https://packagist.org/packages/paulorlima9/laravel-env-set-command)
[![License](https://img.shields.io/github/license/paulorlima9/laravel-env-set-command.svg)](LICENSE.md)
[![CI Status](https://github.com/paulorlima9/laravel-env-set-command/workflows/Run%20Tests/badge.svg)](https://github.com/paulorlima9/laravel-env-set-command/actions)
...
```bash
composer require paulorlima9/laravel-env-set-command:^1.0
```
